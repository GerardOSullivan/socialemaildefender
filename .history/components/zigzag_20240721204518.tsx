      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">What can you do to prevent yourself from being a victim of Phishing?</div>
            <h1 className="h2 mb-4">This is where we come in.</h1>
            <p className="text-xl text-gray-400">Subscribing to our program not only enhances your cybersecurity skills but also offers a cost-effective solution compared to traditional antivirus software. While antivirus programs are crucial for detecting and removing malware, they often struggle to prevent social engineering attacks that rely on human interaction and manipulation rather than technical exploits.</p> 
